...
class ExtractorURLParams(GenericParams):
    host: Literal[
        "Doodstream", "FileLions", "FileMoon", "Mixdrop", "Uqload", "Streamtape", "Supervideo", "VixCloud", "Okru", "Maxstream", "LiveTV", "LuluStream", "DLHD", "Fastream", "Vidmoly", "Vidoza", "Voe", "Sportsonline", "TurboVidPlay","StreamWish"
